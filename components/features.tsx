            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
                ...
                <p className="text-lg text-slate-400 mb-8">
                  Other AI companies can only promise to be careful with your data. We guarantee it. Confidential AI
                  models run inside secure enclaves, which keep data encrypted even while in use. No one - not even us -
                  ever gets a chance to see your data.
                </p>
